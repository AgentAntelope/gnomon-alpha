class GnomonController < ApplicationController
  before_action :hipku
  ...
  def next_action
    [
      ...
      two_path(first: generate_word, second: generate_word),
      three_path(first: generate_word, second: generate_word, third: generate_word),
      four_path(first: generate_word, second: generate_word, third: generate_word, fourth: generate_word),
    ].sample
  end
  helper_method :next_action
